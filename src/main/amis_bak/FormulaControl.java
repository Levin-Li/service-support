...
@Documented
@Inherited
@Schema(title = "公式功能控件。 文档：https://baidu.gitee.io/amis/docs/components/form/formula")
...
////////////////////////////////////////////
     ...
     * @see
     */
    @Schema(title = "字段名，公式结果将作用到此处指定的变量中去")
    String name() default "	";
     ...
     * @see
     */
    @Schema(title = "当某个按钮的目标指定为此值后，会触发一次公式应用。这个机制可以在 autoSet 为 false 时用来手动触发")
    String id() default "	";
     ...
     * @see
     */
    @Schema(title = "触发公式的作用条件，如 data.xxx == a 或者 ${xx}")
