 ...
 * MatrixControl
 *
 * Matrix 选择控件。适合做权限勾选。 文档：https://baidu.gitee.io/amis/docs/components/form/matrix
 *
...
@Documented
@Inherited
@Schema(description = "Matrix 选择控件。适合做权限勾选。 文档：https://baidu.gitee.io/amis/docs/components/form/matrix")
public @interface MatrixControl {
///////////////////////////////////////////
...
////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"matrix-checkboxes","description":"表单项类型"}
     *
     * @see 
     */
    @Schema(description = "表单项类型")
    String type() default "matrix-checkboxes";
     ...
     *
     * 参考定义: {"type":"boolean","description":"配置singleSelectMode时设置为false"}
     *
     * @see 
     */
    @Schema(description = "配置singleSelectMode时设置为false")
    boolean multiple() default false;

    /**
     * 设置单选模式，multiple为false时有效
     *
     * 参考定义: {"type":"boolean","description":"设置单选模式，multiple为false时有效"}
     *
     * @see 
     */
    @Schema(description = "设置单选模式，multiple为false时有效")
    boolean singleSelectMode() default false;
     ...
     * columns
     *
     * 参考定义: {"type":"array","items":{"type":"object","properties":{"label":{"type":"string"}},"required":["label"]}}
     *
     * @see 
     */
     ...
     * 行标题说明
     *
     * 参考定义: {"type":"string","description":"行标题说明"}
     *
     * @see 
     */
    @Schema(description = "行标题说明")
    String rowLabel() default "	";
