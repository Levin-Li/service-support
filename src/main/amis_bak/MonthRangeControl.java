...
@Documented
@Inherited
@Schema(title = "MonthRange 月范围控件 文档：https://baidu.gitee.io/amis/docs/components/form/month-range")
...
////////////////////////////////////////////
     ...
     * 指定为日期范围控件
     *
     * 参考定义: {"type":"string","const":"input-month-range","description":"指定为日期范围控件"}
     *
     * @see
     */
     ...
     *
     * 参考定义: {"type":"string","description":"默认 `YYYY-MM` 用来配置显示的时间格式。"}
     *
     * @see
     */
    @Schema(title = "默认 `YYYY-MM` 用来配置显示的时间格式。")
