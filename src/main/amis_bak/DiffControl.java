...
@Documented
@Inherited
@Schema(title = "Diff 编辑器 文档：https://baidu.gitee.io/amis/docs/components/form/diff")
...
////////////////////////////////////////////
     ...
     * @see
     */
    @Schema(title = "语言，参考 monaco-editor")
