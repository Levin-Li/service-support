...
record EffectiveDataScope(Set<String> tenantScopeList,
    ...
    public Set<String> getTenantScopeList() {
        return tenantScopeList;
    }

    @Override
    public Set<String> getDeniedTenantScopeList() {
        return deniedTenantScopeList;
    }

    @Override
    public Set<String> getDomainScopeList() {
        return domainScopeList;
    }

    @Override
    public Set<String> getDeniedDomainScopeList() {
        return deniedDomainScopeList;
    }
