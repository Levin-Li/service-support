...
//            boolean isAnnotation = typeElement.getKind() == ElementKind.ANNOTATION_TYPE;
            ...
            codeBlock
                    ...
                    .append("    String CACHE_KEY_PREFIX_TXT  = \"CK_\" + CLASS_NAME + \"_\"; // 缓存Key前缀 \n\n")

                    .append("    String CACHE_KEY_PREFIX_EXPR  = \"'\" + CACHE_KEY_PREFIX_TXT + \"' + \"; // 缓存Key前缀 SPEL 表达式 \n\n")

                    .append("    String CACHE_KEY_PREFIX  = CACHE_KEY_PREFIX_EXPR; // 缓存Key前缀 SPEL 表达式 \n\n")
