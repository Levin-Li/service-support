 ...
 * TextareaControl
 *
 * TextArea 多行文本输入框。 文档：https://baidu.gitee.io/amis/docs/components/form/textarea
...
@Documented
@Inherited
@Schema(description = "TextArea 多行文本输入框。 文档：https://baidu.gitee.io/amis/docs/components/form/textarea")
public @interface TextareaControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     * 指定为多行文本输入框
     *
     * 参考定义: {"type":"string","const":"textarea","description":"指定为多行文本输入框"}
     *
     * 
     *
     * 
     ...
     * 最大行数
     *
     * 参考定义: {"type":"number","description":"最大行数"}
     *
     * 
     *
     * 
    ...
    double maxRows() default 0;

    /**
     * 最小行数
     *
     * 参考定义: {"type":"number","description":"最小行数"}
     *
     * 
     *
     * 
     ...
     * 输入内容是否可清除
     *
     * 参考定义: {"type":"boolean","description":"输入内容是否可清除"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "输入内容是否可清除")
    boolean clearable() default false;

    /**
     * 重置值
     *
     * 参考定义: {"type":"string","description":"重置值"}
     *
     * 
     *
     * 
