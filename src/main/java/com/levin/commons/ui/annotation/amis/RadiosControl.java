 ...
 * RadiosControl
 *
 * Radio 单选框。 文档：https://baidu.gitee.io/amis/docs/components/form/radios
 *
...
@Documented
@Inherited
@Schema(description = "Radio 单选框。 文档：https://baidu.gitee.io/amis/docs/components/form/radios")
public @interface RadiosControl {
///////////////////////////////////////////
...
////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"radios","description":"表单项类型"}
     *
     * @see 
     */
    @Schema(description = "表单项类型")
    String type() default "radios";
