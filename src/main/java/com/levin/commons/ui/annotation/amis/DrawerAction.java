...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为打开弹窗，抽出式弹窗
     *
     * 参考定义: {"type":"string","const":"drawer","description":"指定为打开弹窗，抽出式弹窗"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: "#/definitions/DrawerSchemaBase"
     *
     * 
     *
     * 
    ...
    @Schema(title = "抽出式弹框详情 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/drawer")
    DrawerBase drawer() ;
