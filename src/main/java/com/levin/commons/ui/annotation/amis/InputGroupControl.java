...
@Documented
@Inherited
@Schema(title = "InputGroup 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/input-group")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-group","description":"表单项类型"}
     *
     * 
     *
     * 
     ...
     * 校验提示信息配置
     *
     * 参考定义: {"type":"object","properties":{"errorMode":{"type":"string","enum":["full","partial"],"description":"错误提示的展示模式, full为整体飘红, highlight为仅错误项飘红, 默认为full"},"delimiter":{"type":"string","description":"单个子元素多条校验信息的分隔符"}},"additionalProperties":false,"description":"校验提示信息配置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "校验提示信息配置")
    String validationConfig() default "	";
