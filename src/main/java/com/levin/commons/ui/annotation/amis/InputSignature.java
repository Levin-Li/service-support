...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-signature","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "表单项类型")
    String type() default "input-signature";

    /**
     * 组件宽度，默认占满父容器
     *
     * 参考定义: {"type":"number","description":"组件宽度，默认占满父容器"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "组件宽度，默认占满父容器")
    double width() default 0;

    /**
     * 组件高度，默认占满父容器
     *
     * 参考定义: {"type":"number","description":"组件高度，默认占满父容器"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "组件高度，默认占满父容器")
    double height() default 0;

    /**
     * 组件字段颜色
     *
     * 参考定义: {"type":"string","description":"组件字段颜色"}
     *
     * 
     *
     * 
     ...
     * 组件背景颜色
     *
     * 参考定义: {"type":"string","description":"组件背景颜色"}
     *
     * 
     *
     * 
     ...
     * 清空按钮名称
     *
     * 参考定义: {"type":"string","description":"清空按钮名称"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "清空按钮名称")
    String clearBtnLabel() default "	";

    /**
     * 清空按钮图标
     *
     * 参考定义: {"type":"string","description":"清空按钮图标"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "清空按钮图标")
    String clearBtnIcon() default "	";

    /**
     * 撤销按钮名称
     *
     * 参考定义: {"type":"string","description":"撤销按钮名称"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "清空按钮图标")
    String undoBtnIcon() default "	";

    /**
     * 确认按钮名称
     *
     * 参考定义: {"type":"string","description":"确认按钮名称"}
     *
     * 
     *
     * 
     ...
     * 是否内嵌
     *
     * 参考定义: {"type":"boolean","description":"是否内嵌"}
     *
     * 
     *
     * 
     ...
     * 弹窗确认按钮名称
     *
     * 参考定义: {"type":"string","description":"弹窗确认按钮名称"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗确认按钮名称")
    String embedConfirmLabel() default "	";

    /**
     * 弹窗确认按钮图标
     *
     * 参考定义: {"type":"string","description":"弹窗确认按钮图标"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗确认按钮图标")
    String embedConfirmIcon() default "	";

    /**
     * 弹窗取消按钮名称
     *
     * 参考定义: {"type":"string","description":"弹窗取消按钮名称"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗取消按钮名称")
    String ebmedCancelLabel() default "	";

    /**
     * 弹窗取消按钮图标
     *
     * 参考定义: {"type":"string","description":"弹窗取消按钮图标"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗取消按钮图标")
    String ebmedCancelIcon() default "	";

    /**
     * 弹窗按钮图标
     *
     * 参考定义: {"type":"string","description":"弹窗按钮图标"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗按钮图标")
    String embedBtnIcon() default "	";

    /**
     * 弹窗按钮文案
     *
     * 参考定义: {"type":"string","description":"弹窗按钮文案"}
     *
     * 
     *
     * 
