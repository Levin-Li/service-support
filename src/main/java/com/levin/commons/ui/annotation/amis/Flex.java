...
@Documented
@Inherited
@Schema(title = "Flex 布局 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/flex")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为 flex 展示类型
     *
     * 参考定义: {"type":"string","const":"flex","description":"指定为 flex 展示类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "指定为 flex 展示类型")
    String type() default "flex";
     ...
     * 水平分布
     *
     * 参考定义: {"type":"string","enum":["start","flex-start","center","end","flex-end","space-around","space-between","space-evenly"],"description":"水平分布"}
     *
     * 
     *
     * 
     ...
     * 垂直布局
     *
     * 参考定义: {"type":"string","enum":["stretch","start","flex-start","flex-end","end","center","baseline"],"description":"垂直布局"}
     *
     * 
     *
     * 
     ...
     * 多行情况下的垂直分布
     *
     * 参考定义: {"type":"string","enum":["normal","flex-start","flex-end","center","space-between","space-around","space-evenly","stretch"],"description":"多行情况下的垂直分布"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "多行情况下的垂直分布")
    AlignContent alignContent() ;

    /**
     * 方向
     *
     * 参考定义: {"type":"string","enum":["row","column","row-reverse","column-reverse"],"description":"方向"}
     *
     * 
     *
     * 
