...
////////////////////////////////////////////
   ...
   String value() default "";
     ...
     *
     * 参考定义: {"type":"string","const":"link","description":"指定为打开链接行为，跟 url 不同的时这个行为为单页模式。"}
     *
     * @see 
     */
    @Schema(description = "指定为打开链接行为，跟 url 不同的时这个行为为单页模式。")
    String actionType() default "link";

    /**
     * 跳转到哪？支持配置相对路径。
     *
     * 参考定义: {"type":"string","description":"跳转到哪？支持配置相对路径。"}
     *
     * @see 
     */
    @Schema(description = "跳转到哪？支持配置相对路径。")
    String link() default "";
