 ...
 * UUIDControl
 *
 * \"UUID 功能性组件 文档：https://baidu.gitee.io/amis/docs/components/form/uuid\"
 *
...
@Documented
@Inherited
@Schema(description = "\"UUID 功能性组件 文档：https://baidu.gitee.io/amis/docs/components/form/uuid\"")
public @interface UUIDControl {
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"uuid","description":"表单项类型"}
     *
     * @see 
     */
     ...
     *
     * 参考定义: {"type":"number","description":"长度，默认 uuid 的长度是 36，如果不需要那么长，可以设置这个来缩短"}
     *
     * @see 
     */
    @Schema(description = "长度，默认 uuid 的长度是 36，如果不需要那么长，可以设置这个来缩短")
    double length() default 0;
