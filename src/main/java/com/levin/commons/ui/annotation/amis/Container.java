...
@Documented
@Inherited
@Schema(title = "Container 容器渲染器。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/container")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     *
     * 参考定义: {"type":"boolean","description":"是否需要对body加一层div包裹，默认为 true"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否需要对body加一层div包裹，默认为 true")
    boolean wrapperBody() default false;

    /**
     * 是否开启容器拖拽
     *
     * 参考定义: {"type":["boolean","string"],"description":"是否开启容器拖拽"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否开启容器拖拽")
    String draggable() default "	";

    /**
     * 是否开启容器拖拽配置
     *
     * 参考定义: {"anyOf":[{"$ref":"#/definitions/ContainerDraggableConfig"},{"type":"string"}],"description":"是否开启容器拖拽配置"}
     *
     * [{"$ref":"#/definitions/ContainerDraggableConfig"},{"type":"string"}]
     *
     * 
     *
     * @see 
    ...
    @Schema(title = "是否开启容器拖拽配置")
    String draggableConfig() default "	";
