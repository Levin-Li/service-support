...
@Documented
@Inherited
@Schema(title = "Group 表单集合渲染器，能让多个表单在一行显示 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/group")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"group","description":"表单项类型"}
     *
     * 
     *
     * 
     ...
     * 间隔
     *
     * 参考定义: {"type":"string","enum":["xs","sm","normal"],"description":"间隔"}
     *
     * 
     *
     * 
     ...
     * 配置时垂直摆放还是左右摆放。
     *
     * 参考定义: {"type":"string","enum":["horizontal","vertical"],"description":"配置时垂直摆放还是左右摆放。"}
     *
     * 
     *
     * 
