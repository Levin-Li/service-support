 ...
 * FormulaControl
 *
 * 公式功能控件。 文档：https://baidu.gitee.io/amis/docs/components/form/formula
 *
...
@Documented
@Inherited
@Schema(description = "公式功能控件。 文档：https://baidu.gitee.io/amis/docs/components/form/formula")
public @interface FormulaControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     *
     * 参考定义: {"type":"string","description":"当某个按钮的目标指定为此值后，会触发一次公式应用。这个机制可以在 autoSet 为 false 时用来手动触发"}
     *
     * @see 
     */
    @Schema(description = "当某个按钮的目标指定为此值后，会触发一次公式应用。这个机制可以在 autoSet 为 false 时用来手动触发")
    String id() default "	";
     ...
     * 指定为公式功能控件。
     *
     * 参考定义: {"type":"string","const":"formula","description":"指定为公式功能控件。"}
     *
     * @see 
     */
    @Schema(description = "指定为公式功能控件。")
     ...
     *
     * 参考定义: {"type":"string","description":"字段名，公式结果将作用到此处指定的变量中去"}
     *
     * @see 
     */
    @Schema(description = "字段名，公式结果将作用到此处指定的变量中去")
    String name() default "	";
     ...
     *
     * 参考定义: {"type":"string","description":"触发公式的作用条件，如 data.xxx == \\\"a\\\" 或者 ${xx}"}
     *
     * @see 
     */
    @Schema(description = "触发公式的作用条件，如 data.xxx == a 或者 ${xx}")
    String condition() default "	";

    /**
     * 是否自动应用
     *
     * 参考定义: {"type":"boolean","description":"是否自动应用"}
     *
     * @see 
     */
    @Schema(description = "是否自动应用")
    boolean autoSet() default false;

    /**
     * 公式
     *
     * 参考定义: {"type":"string","description":"公式"}
     *
     * @see 
     */
     ...
     * 是否初始应用
     *
     * 参考定义: {"type":"boolean","description":"是否初始应用"}
     *
     * @see 
     */
    @Schema(description = "是否初始应用")
    boolean initSet() default false;
