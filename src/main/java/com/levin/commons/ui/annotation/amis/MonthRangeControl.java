...
@Documented
@Inherited
@Schema(title = "MonthRange 月范围控件 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/month-range")
...
//////////////////////////////////////////////
     ...
     *
     * 参考定义: {"type":"string","description":"用来提交的时间格式。更多格式类型请参考 moment.（新：同format）"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "用来提交的时间格式。更多格式类型请参考 moment.（新：同format）")
     ...
     *
     * 参考定义: {"type":"string","description":"用来配置显示的时间格式（新：同inputFormat）"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "用来配置显示的时间格式（新：同inputFormat）")
     ...
     * 是否启用游标动画，默认开启
     *
     * 参考定义: {"type":"boolean","description":"是否启用游标动画，默认开启"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: {"type":"string","description":"日期数据处理函数，用来处理选择日期之后的的值\n\n(value: moment.Moment, config: {type: 'start' | 'end'; originValue: moment.Moment, timeFormat: string}, props: any, data: any, moment: moment) => moment.Moment;"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "日期数据处理函数，用来处理选择日期之后的的值\n\n(value: moment.Moment, config: {type: 'start' | 'end'; originValue: moment.Moment, timeFormat: string}, props: any, data: any, moment: moment) => moment.Moment;")
     ...
     * type
     *
     * 参考定义: {"type":"string","const":"input-month-range"}
     *
     * 
     *
     * 
