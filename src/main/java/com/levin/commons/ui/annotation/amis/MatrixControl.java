...
@Documented
@Inherited
@Schema(title = "Matrix 选择控件。适合做权限勾选。 文档：https://baidu.gitee.io/amis/docs/components/form/matrix")
...
//////////////////////////////////////////////
    ...
    @Schema(title = "配置singleSelectMode时设置为false")
    ...
    @Schema(title = "设置单选模式，multiple为false时有效")
