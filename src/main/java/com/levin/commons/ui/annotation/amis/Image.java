...
@Documented
@Inherited
@Schema(title = "图片展示控件。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/image")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
    ...
    boolean enlargeWithGallary() default false;
