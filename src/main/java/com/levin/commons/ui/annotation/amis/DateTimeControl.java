...
@Documented
@Inherited
@Schema(title = "Datetime日期时间选择控件 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/datetime")
...
//////////////////////////////////////////////
     ...
     * 指定为日期时间选择控件
     *
     * 参考定义: {"type":"string","const":"input-datetime","description":"指定为日期时间选择控件"}
     *
     * 
     *
     * 
     ...
     * 替代format
     *
     * 参考定义: {"type":"string","description":"替代format"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: {"type":"string","description":"日期展示格式(新：替代inputFormat)"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "日期展示格式(新：替代inputFormat)")
     ...
     * 日期快捷键
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"type":"array","items":{"$ref":"#/definitions/ShortCuts"}}],"description":"日期快捷键"}
     *
     ...
     *
     * 参考定义: {"type":"string","description":"字符串函数，用来决定是否禁用某个日期。\n\n(currentDate: moment.Moment, props: any) => boolean;"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "字符串函数，用来决定是否禁用某个日期。\n\n(currentDate: moment.Moment, props: any) => boolean;")
     ...
     * 限制最小日期
     *
     * 参考定义: {"type":"string","description":"限制最小日期"}
     *
     * 
     *
     * 
     ...
     * 限制最大日期
     *
     * 参考定义: {"type":"string","description":"限制最大日期"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "时间输入范围限制")
    String timeConstraints() default "	";

    /**
     * 是否为结束时间，如果是，那么会自动加上 23:59:59
     *
     * 参考定义: {"type":"boolean","description":"是否为结束时间，如果是，那么会自动加上 23:59:59"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否为结束时间，如果是，那么会自动加上 23:59:59")
