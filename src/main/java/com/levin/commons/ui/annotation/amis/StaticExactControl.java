 ...
 * StaticExactControl
 *
 * Static 文档：https://baidu.gitee.io/amis/docs/components/form/static
 *
...
@Documented
@Inherited
@Schema(description = "Static 文档：https://baidu.gitee.io/amis/docs/components/form/static")
public @interface StaticExactControl {
///////////////////////////////////////////
...
////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"static","description":"表单项类型"}
     *
     * @see 
     */
     ...
     * @see 
     */
    @Schema(description = "内容模板， 支持 HTML")
    Tpl tpl() ;
     ...
     * @see 
     */
    @Schema(description = "内容模板，不支持 HTML")
    Tpl text() ;
     ...
     * 边框模式，默认是无边框的
     *
     * 参考定义: {"type":"string","enum":["full","half","none"],"description":"边框模式，默认是无边框的"}
     *
     * @see 
     */
    @Schema(description = "边框模式，默认是无边框的")
