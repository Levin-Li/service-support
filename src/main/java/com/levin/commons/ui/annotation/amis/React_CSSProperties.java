...
//////////////////////////////////////////////
   ...
   String value() default "	";
    ...
    @Schema(description = "The **`float`** CSS property places an element on the left or right side of its container, allowing text and inline elements to wrap around it. The element is removed from the normal flow of the page, though still remaining a part of the flow (in contrast to absolute positioning).nn**Syntax**: `left | right | none | inline-start | inline-end`nn**Initial value**: `none`nn| Chrome | Firefox | Safari |  Edge  |  IE   | | :----: | :-----: | :----: | :----: | :---: | | **1**  |  **1**  | **1**  | **12** | **4** |")
