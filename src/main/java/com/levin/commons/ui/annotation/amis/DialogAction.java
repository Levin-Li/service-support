...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为打开弹窗
     *
     * 参考定义: {"type":"string","const":"dialog","description":"指定为打开弹窗"}
     *
     *
     *
     *
    ...
    @Schema(title = "指定为打开弹窗")
    String actionType() default "dialog";

    /**
     * 弹框详情 文档：https://baidu.gitee.io/amis/docs/components/dialog
     *
    ...
    @Schema(title = "弹框详情 文档：https://baidu.gitee.io/amis/docs/components/dialog")
    DialogBase dialog() ;
    ...
    @Schema(title = "是否有下一个的表达式，正常可以不用配置，如果想要刷掉某些数据可以配置这个。")
