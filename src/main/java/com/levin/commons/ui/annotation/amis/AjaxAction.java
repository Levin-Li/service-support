...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为发送 ajax 的行为。
     *
     * 参考定义: {"type":"string","const":"ajax","description":"指定为发送 ajax 的行为。"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "指定为发送 ajax 的行为。")
    String actionType() default "ajax";
    ...
    @Schema(title = "配置 ajax 发送地址")
    String api() default "	";

    /**
     * feedback
     *
     * 参考定义: "#/definitions/FeedbackDialog"
     *
     * 
     *
     * 
    ...
    @Schema(title = "ignoreConfirm")
    boolean ignoreConfirm() default false;

    /**
     * 是否开启请求隔离, 主要用于隔离联动CRUD, Service的请求
     *
     * 参考定义: {"type":"boolean","description":"是否开启请求隔离, 主要用于隔离联动CRUD, Service的请求"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否开启请求隔离, 主要用于隔离联动CRUD, Service的请求")
    boolean isolateScope() default false;
