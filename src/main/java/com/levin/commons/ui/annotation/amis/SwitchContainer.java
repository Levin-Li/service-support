...
@Documented
@Inherited
@Schema(title = "SwitchContainer 状态容器渲染器。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/state-container")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为 container 类型
     *
     * 参考定义: {"type":"string","const":"switch-container","description":"指定为 container 类型"}
     *
     * 
     *
     * 
    ...
    String type() default "switch-container";
