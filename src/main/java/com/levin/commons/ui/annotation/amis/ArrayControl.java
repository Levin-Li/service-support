...
@Documented
@Inherited
@Schema(title = "InputArray 数组输入框。 combo 的别名。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/array")
...
//////////////////////////////////////////////
     ...
     * Add at top
     *
     * 参考定义: {"type":"boolean","description":"Add at top"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "Add at top")
    boolean addattop() default false;
    ...
    @Schema(title = "updatePristineAfterStoreDataReInit")
    boolean updatePristineAfterStoreDataReInit() default false;
