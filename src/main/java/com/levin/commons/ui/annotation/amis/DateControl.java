...
@Documented
@Inherited
@Schema(title = "Date日期选择控件 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/date")
...
//////////////////////////////////////////////
     ...
     * 指定为日期选择控件
     *
     * 参考定义: {"type":"string","const":"input-date","description":"指定为日期选择控件"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "指定为日期选择控件")
    String type() default "input-date";
     ...
     * 点选日期后是否关闭弹窗
     *
     * 参考定义: {"type":"boolean","description":"点选日期后是否关闭弹窗"}
     *
     * 
     *
     * 
     ...
     * 弹窗容器选择器
     *
     * 参考定义: {"type":"string","description":"弹窗容器选择器"}
     *
     * 
     *
     * 
