 ...
 * DateControl
 *
 * Date日期选择控件 文档：https://baidu.gitee.io/amis/docs/components/form/date
 *
...
@Documented
@Inherited
@Schema(description = "Date日期选择控件 文档：https://baidu.gitee.io/amis/docs/components/form/date")
...
////////////////////////////////////////////
     ...
     * @see 
     */
    @Schema(description = "点选日期后是否关闭弹窗")
