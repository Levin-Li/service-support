...
@Documented
@Inherited
@Schema(title = "List 复选框 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/list")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"list-select","description":"表单项类型"}
     *
     * 
     *
     * 
     ...
     * 开启双击点选并提交。
     *
     * 参考定义: {"type":"boolean","description":"开启双击点选并提交。"}
     *
     * 
     *
     * 
     ...
     * 图片div类名
     *
     * 参考定义: {"type":"string","description":"图片div类名"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "激活态自定义展示模板。")
    String activeItem() default "	";
