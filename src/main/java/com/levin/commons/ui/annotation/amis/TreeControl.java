...
@Documented
@Inherited
@Schema(title = "Tree 下拉选择框。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/tree")
...
//////////////////////////////////////////////
    ...
    @Schema(title = "该属性代表数据级联关系，autoCheckChildren为true时生效，默认为false，具体数据级联关系如下： 1.casacde为false，ui行为为级联选中子节点，子节点禁用；值只包含父节点的值 2.cascade为false，withChildren为true，ui行为为级联选中子节点，子节点禁用；值包含父子节点的值 3.cascade为true，ui行为级联选中子节点，子节点可反选，值包含父子节点的值，此时withChildren属性失效 4.cascade不论为true还是false，onlyChildren为true，ui行为级联选中子节点，子节点可反选，值只包含子节点的值")
     ...
     * 单选时，只运行选择叶子节点
     *
     * 参考定义: {"type":"boolean","description":"单选时，只运行选择叶子节点"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "开启节点路径模式后，节点路径的分隔符")
    ...
    @Schema(title = "是否显示展开线")
    boolean showOutline() default false;

    /**
     * 需要高亮的字符串
     *
     * 参考定义: {"type":"string","description":"需要高亮的字符串"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "需要高亮的字符串")
    String highlightTxt() default "	";

    /**
     * 是否为选项添加默认的Icon，默认值为true
     *
     * 参考定义: {"type":"boolean","description":"是否为选项添加默认的Icon，默认值为true"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否为选项添加默认的Icon，默认值为true")
    boolean enableDefaultIcon() default false;
     ...
     * 搜索框的配置
     *
     * 参考定义: {"type":"object","properties":{"className":{"type":"string","description":"搜索框外层CSS样式类"},"placeholder":{"type":"string","description":"占位符"},"mini":{"type":"boolean","description":"是否为 Mini 样式。"},"enhance":{"type":"boolean","description":"是否为加强样式"},"clearable":{"type":"boolean","description":"是否可清除"},"searchImediately":{"type":"boolean","description":"是否立马搜索。"},"sticky":{"type":"boolean","description":"搜索框是否吸顶"}},"additionalProperties":false,"description":"搜索框的配置"}
     *
     * 
     *
     * 
     ...
     * 高度自动增长？
     *
     * 参考定义: {"type":"boolean","description":"高度自动增长？"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "高度自动增长？")
    boolean heightAuto() default false;
