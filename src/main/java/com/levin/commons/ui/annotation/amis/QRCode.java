...
@Documented
@Inherited
@Schema(title = "二维码展示控件。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/qrcode")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 图片配置
     *
     * 参考定义: "#/definitions/QRCodeImageSettings"
     *
     * 
     *
     * 
     *
     * @see QRCodeImageSettings
     */
    
    @Schema(title = "图片配置")
    QRCodeImageSettings imageSettings() ;
