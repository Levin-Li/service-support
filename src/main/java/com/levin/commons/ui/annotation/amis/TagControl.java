...
@Documented
@Inherited
@Schema(title = "Tag 输入框 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/tag")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-tag","description":"表单项类型"}
     *
     * 
     *
     * 
     ...
     * 选项提示信息
     *
     * 参考定义: {"type":"string","description":"选项提示信息"}
     *
     * 
     *
     * 
     ...
     * 是否为下拉模式
     *
     * 参考定义: {"type":"boolean","description":"是否为下拉模式"}
     *
     * 
     *
     * 
     ...
     * 允许添加的标签的最大数量
     *
     * 参考定义: {"type":"number","description":"允许添加的标签的最大数量"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "允许添加的标签的最大数量")
    double max() default 0;

    /**
     * 单个标签的最大文本长度
     *
     * 参考定义: {"type":"number","description":"单个标签的最大文本长度"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "单个标签的最大文本长度")
    double maxTagLength() default 0;
     ...
     * 收纳标签的Popover配置
     *
     * 参考定义: "#/definitions/TooltipWrapperSchema"
     *
     * 
     *
     * 
    ...
    TooltipWrapper overflowTagPopover() ;

    /**
     * 是否开启批量添加模式
     *
     * 参考定义: {"type":"boolean","description":"是否开启批量添加模式"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否开启批量添加模式")
    boolean enableBatchAdd() default false;

    /**
     * 开启批量添加后，输入多个标签的分隔符，支持传入多个符号，默认为-
     *
     * 参考定义: {"type":"string","description":"开启批量添加后，输入多个标签的分隔符，支持传入多个符号，默认为\"-\"","default":"-"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "开启批量添加后，输入多个标签的分隔符，支持传入多个符号，默认为-")
