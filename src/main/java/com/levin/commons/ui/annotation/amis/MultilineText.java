...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * type
     *
     * 参考定义: {"type":"string","const":"multiline-text"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "type")
    String type() default "multiline-text";
     ...
     * 展开按钮文本
     *
     * 参考定义: {"type":"string","description":"展开按钮文本"}
     *
     * 
     *
     * 
     ...
     * 收起按钮文本
     *
     * 参考定义: {"type":"string","description":"收起按钮文本"}
     *
     * 
     *
     * 
