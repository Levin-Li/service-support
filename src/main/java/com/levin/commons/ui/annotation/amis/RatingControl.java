...
@Documented
@Inherited
@Schema(title = "Rating 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/rating")
...
//////////////////////////////////////////////
     ...
     * 
     *
     * @see TextPositionType
     */
    
    @Schema(title = "文字的位置")
    String textPosition() default "	";
