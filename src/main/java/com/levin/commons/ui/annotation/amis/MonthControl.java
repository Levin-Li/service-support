...
@Documented
@Inherited
@Schema(title = "Month 月份选择控件 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/Month")
...
//////////////////////////////////////////////
     ...
     * 指定为月份时间选择控件
     *
     * 参考定义: {"type":"string","const":"input-month","description":"指定为月份时间选择控件"}
     *
     * 
     *
     * 
    ...
    String type() default "input-month";
     ...
     * 月份存储格式
     *
     * 参考定义: {"type":"string","description":"月份存储格式"}
     *
     * 
     *
     * 
     ...
     * 月份展示格式
     *
     * 参考定义: {"type":"string","description":"月份展示格式"}
     *
     * 
     *
     * 
