 ...
 * RepeatControl
 *
 * Repeat 文档：https://baidu.gitee.io/amis/docs/components/form/repeat
 *
...
@Documented
@Inherited
@Schema(description = "Repeat 文档：https://baidu.gitee.io/amis/docs/components/form/repeat")
public @interface RepeatControl {
///////////////////////////////////////////
...
////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-repeat","description":"表单项类型"}
     *
     * @see 
     */
    @Schema(description = "表单项类型")
    String type() default "input-repeat";
