...
@Documented
@Inherited
@Schema(title = "RichText 文档：https://baidu.gitee.io/amis/docs/components/form/input-rich-text")
...
//////////////////////////////////////////////
    ...
    @Schema(title = "tinymce 或 froala 的配置")
