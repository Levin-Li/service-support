 ...
 * RichTextControl
 *
 * RichText 文档：https://baidu.gitee.io/amis/docs/components/form/input-rich-text
...
@Documented
@Inherited
@Schema(description = "RichText 文档：https://baidu.gitee.io/amis/docs/components/form/input-rich-text")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-rich-text","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    String type() default "input-rich-text";
     ...
     * 编辑器类型
     *
     * 参考定义: {"type":"string","enum":["froala","tinymce"],"description":"编辑器类型"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "视频保存 API")
    String videoReceiver() default "	";

    /**
     * 接收器的字段名
     *
     * 参考定义: {"type":"string","description":"接收器的字段名"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: {"description":"tinymce 或 froala 的配置"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "tinymce 或 froala 的配置")
