...
@Documented
@Inherited
@Schema(title = "IFrame 渲染器 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/iframe")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * referrerpolicy
     *
     * 参考定义: {"type":"string","enum":["no-referrer","no-referrer-when-downgrade","origin","origin-when-cross-origin","same-origin","strict-origin","strict-origin-when-cross-origin","unsafe-url"]}
     *
     * 
     *
     * 
