...
@Documented
@Inherited
@Schema(title = "Picker 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/picker")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"picker","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "可用来生成选中的值的描述文字")
    Tpl labelTpl() ;

    /**
     * 建议用 labelTpl 选中一个字段名用来作为值的描述文字
     *
     * 参考定义: {"type":"string","description":"建议用 labelTpl 选中一个字段名用来作为值的描述文字"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "建议用 labelTpl 选中一个字段名用来作为值的描述文字")
    String labelField() default "	";

    /**
     * 选一个可以用来作为值的字段。
     *
     * 参考定义: {"type":"string","description":"选一个可以用来作为值的字段。"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "选一个可以用来作为值的字段。")
    String valueField() default "	";

    /**
     * picker
     *
     * 参考定义: {"description":"弹窗选择框详情。"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗选择框详情。")
    String picker() default "	";

    /**
     * 弹窗模式，dialog 或者 drawer
     *
     * 参考定义: {"type":"string","enum":["dialog","drawer"],"description":"弹窗模式，dialog 或者 drawer"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗模式，dialog 或者 drawer")
    ModalMode modalMode() ;

    /**
     * 弹窗的标题，默认为情选择
     *
     * 参考定义: {"type":"string","description":"弹窗的标题，默认为情选择"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "弹窗的标题，默认为情选择")
    String modalTitle() default "	";

    /**
     * 内嵌模式，也就是说不弹框了。
     *
     * 参考定义: {"type":"boolean","description":"内嵌模式，也就是说不弹框了。"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "内嵌模式，也就是说不弹框了。")
    boolean embed() default false;

    /**
     * 开启最大标签展示数量的相关配置
     *
     * 参考定义: {"type":"object","properties":{"maxTagCount":{"type":"number","description":"标签的最大展示数量，超出数量后以收纳浮层的方式展示，仅在多选模式开启后生效"},"displayPosition":{"type":"array","items":{"type":"string","enum":["select","crud"]},"description":"开启最大标签展示数量后，收纳标签生效的位置，未开启内嵌模式默认为选择器, 开启后默认为选择器 + 模态框，可选值为'select'(选择器)、'crud'(增删改查)"},"overflowTagPopover":{"$ref":"#/definitions/TooltipWrapperSchema","description":"开启最大标签展示数量后，选择器内收纳标签的Popover配置"},"overflowTagPopoverInCRUD":{"$ref":"#/definitions/TooltipWrapperSchema","description":"开启最大标签展示数量后，CRUD顶部内收纳标签的Popover配置"}},"additionalProperties":false,"description":"开启最大标签展示数量的相关配置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "开启最大标签展示数量的相关配置")
    String overflowConfig() default "	";
