...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 指定为复制内容行为
     *
     * 参考定义: {"type":"string","const":"copy","description":"指定为复制内容行为"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "指定为复制内容行为")
    String actionType() default "copy";
    ...
    @Schema(description = "复制啥内容由此配置，支持模板语法。")
    Tpl copy() ;
