...
@Documented
@Inherited
@Schema(title = "数字输入框 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/input-number")
...
//////////////////////////////////////////////
     ...
     * 是否显示上下点击按钮
     *
     * 参考定义: {"type":"boolean","description":"是否显示上下点击按钮"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: {"type":"boolean","description":"是否是大数，如果是的话输入输出都将是字符串"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否是大数，如果是的话输入输出都将是字符串")
