 ...
 * DiffControl
 *
 * Diff 编辑器 文档：https://baidu.gitee.io/amis/docs/components/form/diff
...
@Documented
@Inherited
@Schema(description = "Diff 编辑器 文档：https://baidu.gitee.io/amis/docs/components/form/diff")
public @interface DiffControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     * 指定为 Diff 编辑器
     *
     * 参考定义: {"type":"string","const":"diff-editor","description":"指定为 Diff 编辑器"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "指定为 Diff 编辑器")
    String type() default "diff-editor";
    ...
    @Schema(description = "左侧面板的值， 支持取变量。")
    String diffValue() default "	";

    /**
     * 语言，参考 monaco-editor
     *
     * 参考定义: {"type":"string","description":"语言，参考 monaco-editor"}
     *
     * 
     *
     * 
    ...
    @Schema(description = "语言，参考 monaco-editor")
    String language() default "	";

    /**
     * 编辑器配置
     *
     * 参考定义: {"description":"编辑器配置"}
     *
     * 
     *
     * 
