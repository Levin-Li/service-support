 ...
 * JSONEditorControl
 *
 * JSON Schema Editor 文档：https://baidu.gitee.io/amis/docs/components/form/json-schema-editor
 *
...
@Documented
@Inherited
@Schema(description = "JSON Schema Editor 文档：https://baidu.gitee.io/amis/docs/components/form/json-schema-editor")
...
//////////////////////////////////////////////
     ...
     * @see 
     */
    @Schema(description = "指定为 JSON Schema Editor")
     ...
     * @see 
     */
    @Schema(description = "可以理解为类型模板，方便快速定义复杂类型")
     ...
     * @see 
     */
    @Schema(description = "禁用类型，默认禁用了 null 类型")
