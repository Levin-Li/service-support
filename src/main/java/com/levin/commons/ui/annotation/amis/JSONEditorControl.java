...
@Documented
@Inherited
@Schema(title = "JSON Schema Editor 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/json-schema-editor")
public @interface JSONEditorControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     *
     * 参考定义: {"type":"string","const":"json-schema-editor","description":"指定为 JSON Schema Editor"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "指定为 JSON Schema Editor")
    String type() default "json-schema-editor";
     ...
     *
     * 参考定义: {"type":"object","additionalProperties":{"type":"object","properties":{"title":{"type":"string"},"type":{"type":"string","enum":["string","number","integer","object","array","boolean","null"]}},"required":["title","type"]},"description":"可以理解为类型模板，方便快速定义复杂类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "可以理解为类型模板，方便快速定义复杂类型")
    String definitions() default "	";

    /**
     * 顶层是否允许修改类型
     *
     * 参考定义: {"type":"boolean","description":"顶层是否允许修改类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "顶层是否允许修改类型")
    boolean rootTypeMutable() default false;

    /**
     * 顶层类型信息是否隐藏
     *
     * 参考定义: {"type":"boolean","description":"顶层类型信息是否隐藏"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "顶层类型信息是否隐藏")
    boolean showRootInfo() default false;

    /**
     * 禁用类型，默认禁用了 null 类型
     *
     * 参考定义: {"type":"array","items":{"type":"string"},"description":"禁用类型，默认禁用了 null 类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "禁用类型，默认禁用了 null 类型")
    String[] disabledTypes() default "	";

    /**
     * 开启详情配置
     *
     * 参考定义: {"type":"boolean","description":"开启详情配置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "开启详情配置")
    boolean enableAdvancedSetting() default false;

    /**
     * 自定义详情配置面板如：\n\n{   boolean: [      {type: input-text, name: aa, label: AA }   ] }\n\n当配置布尔字段详情时，就会出现以上配置
     *
     * 参考定义: {"type":"object","description":"自定义详情配置面板如：\n\n{   boolean: [      {type: \"input-text\", name: \"aa\", label: \"AA\" }   ] }\n\n当配置布尔字段详情时，就会出现以上配置"}
     *
     * 
     *
     * 
     ...
     *
     * 参考定义: "#/definitions/SchemaEditorItemPlaceholder"
     *
     * 
     *
     * 
     *
     * @see EditorItemPlaceholder
     */
    
    @Schema(title = "各属性输入控件的占位提示文本\n\n{   key: key placeholder,   title: title placeholder,   description: description placeholder,   default: default placeholder }")
    EditorItemPlaceholder placeholder() ;

    /**
     * 是否为迷你模式，会隐藏一些不必要的元素
     *
     * 参考定义: {"type":"boolean","description":"是否为迷你模式，会隐藏一些不必要的元素"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否为迷你模式，会隐藏一些不必要的元素")
