...
@Documented
@Inherited
@Schema(title = "City 城市选择框。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/city")
...
//////////////////////////////////////////////
    ...
    @Schema(title = "开启后只会存城市的 code 信息")
    ...
    @Schema(title = "是否显示搜索框")
    boolean searchable() default false;

    /**
     * 下拉框className
     *
     * 参考定义: {"type":"string","description":"下拉框className"}
     *
     * 
     *
     * 
