 ...
 * InputCityControl
 *
 * City 城市选择框。 文档：https://baidu.gitee.io/amis/docs/components/form/city
 *
...
@Documented
@Inherited
@Schema(description = "City 城市选择框。 文档：https://baidu.gitee.io/amis/docs/components/form/city")
public @interface InputCityControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     * 指定为城市选择框。
     *
     * 参考定义: {"type":"string","const":"input-city","description":"指定为城市选择框。"}
     *
     * @see 
     */
    @Schema(description = "指定为城市选择框。")
    String type() default "input-city";
     ...
     * 开启后只会存城市的 code 信息
     *
     * 参考定义: {"type":"boolean","description":"开启后只会存城市的 code 信息"}
     *
     * @see 
     */
    @Schema(description = "开启后只会存城市的 code 信息")
    boolean extractValue() default false;

    /**
     * 是否将各个信息拼接成字符串。
     *
     * 参考定义: {"type":"boolean","description":"是否将各个信息拼接成字符串。"}
     *
     * @see 
     */
    @Schema(description = "是否将各个信息拼接成字符串。")
    boolean joinValues() default false;

    /**
     * 拼接的符号是啥？
     *
     * 参考定义: {"type":"string","description":"拼接的符号是啥？"}
     *
     * @see 
     */
    @Schema(description = "拼接的符号是啥？")
    String delimiter() default "	";

    /**
     * 允许选择城市？
     *
     * 参考定义: {"type":"boolean","description":"允许选择城市？"}
     *
     * @see 
     */
    @Schema(description = "允许选择城市？")
    boolean allowCity() default false;

    /**
     * 允许选择地区？
     *
     * 参考定义: {"type":"boolean","description":"允许选择地区？"}
     *
     * @see 
     */
    @Schema(description = "允许选择地区？")
    boolean allowDistrict() default false;

    /**
     * 允许选择街道？
     *
     * 参考定义: {"type":"boolean","description":"允许选择街道？"}
     *
     * @see 
     */
    @Schema(description = "允许选择街道？")
    boolean allowStreet() default false;

    /**
     * 是否显示搜索框
     *
     * 参考定义: {"type":"boolean","description":"是否显示搜索框"}
     *
     * @see 
     */
    @Schema(description = "是否显示搜索框")
