...
@Documented
@Inherited
@Schema(title = "Select 下拉选择框。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/select")
...
//////////////////////////////////////////////
     ...
     * 可多选条件下，是否可全选
     *
     * 参考定义: {"type":"boolean","description":"可多选条件下，是否可全选"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "可多选条件下，是否可全选")
    boolean checkAll() default false;

    /**
     * 可多选条件下，是否默认全选中所有值
     *
     * 参考定义: {"type":"boolean","description":"可多选条件下，是否默认全选中所有值"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "可多选条件下，是否默认全选中所有值")
    boolean defaultCheckAll() default false;

    /**
     * 可多选条件下，全选项文案，默认 ”全选“
     *
     * 参考定义: {"type":"string","description":"可多选条件下，全选项文案，默认 ”全选“"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "可多选条件下，全选项文案，默认 ”全选“")
    String checkAllLabel() default "	";

    /**
     * 标签的最大展示数量，超出数量后以收纳浮层的方式展示，仅在多选模式开启后生效
     *
     * 参考定义: {"type":"number","description":"标签的最大展示数量，超出数量后以收纳浮层的方式展示，仅在多选模式开启后生效"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "标签的最大展示数量，超出数量后以收纳浮层的方式展示，仅在多选模式开启后生效")
    double maxTagCount() default 0;

    /**
     * 收纳标签的Popover配置
     *
     * 参考定义: {"type":"object","description":"收纳标签的Popover配置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "收纳标签的Popover配置")
    String overflowTagPopover() default "	";
    ...
    @Schema(title = "选项的自定义CSS类名")
    String optionClassName() default "	";

    /**
     * 下拉框 Popover 设置
     *
     * 参考定义: {"type":"object","properties":{"width":{"type":["number","string"],"description":"下拉框 Popover 的宽度设置，支持单位 '%'、'px'、'rem'、'em'、'vw', 支持相对写法如 '+20px'"},"align":{"type":"string","enum":["left","center","right"],"description":"下拉框 Popover 的对齐方式"},"filterOption":{"type":"string","const":"string","description":"检索函数"}},"additionalProperties":false,"description":"下拉框 Popover 设置"}
     *
     * 
     *
     * 
