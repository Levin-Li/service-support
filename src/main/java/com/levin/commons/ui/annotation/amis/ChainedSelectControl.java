...
@Documented
@Inherited
@Schema(title = "链式下拉框 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/chained-select")
public @interface ChainedSelectControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"chained-select","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "表单项类型")
    String type() default "chained-select";
