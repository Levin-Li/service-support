...
@Documented
@Inherited
@Schema(title = "Divider 分割线渲染器。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/divider")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * direction
     *
     * 参考定义: {"type":"string","enum":["horizontal","vertical"]}
     *
     * 
     *
     * 
    ...
    @Schema(title = "titleClassName")
    String titleClassName() default "	";

    /**
     * titlePosition
     *
     * 参考定义: {"type":"string","enum":["left","center","right"]}
     *
     * 
     *
     * 
