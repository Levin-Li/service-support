...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 展示限制, 为0时也无限制
     *
     * 参考定义: {"type":"number","description":"展示限制, 为0时也无限制"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "展示限制, 为0时也无限制")
    double limit() default 0;

    /**
     * 展示文字
     *
     * 参考定义: {"type":"string","description":"展示文字"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "展示文字")
    String expendButtonText() default "	";
    ...
    @Schema(title = "展示文字")
    String expendButton() default "	";

    /**
     * 收起文字
     *
     * 参考定义: {"type":"string","description":"收起文字"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "收起文字")
    String collapseButtonText() default "	";
    ...
    @Schema(title = "展示文字")
    String collapseButton() default "	";

    /**
     * tags数据
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"type":"array","items":{"type":"string"}}],"description":"tags数据"}
     *
     ...
     *
     * 参考定义: {"anyOf":[{"type":"boolean"},{"$ref":"#/definitions/TagSchema"}],"description":"useTag 当数据是数组时，是否使用tag的方式展示"}
     *
     * [{"type":"boolean"},{"$ref":"#/definitions/TagSchema"}]
     *
     * 
     *
     * @see 
    ...
    @Schema(title = "useTag 当数据是数组时，是否使用tag的方式展示")
    String inTag() default "	";
