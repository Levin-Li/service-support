 ...
 * TabsTransferControl
 *
 * TabsTransfer 文档：https://baidu.gitee.io/amis/docs/components/form/tabs-transfer
 *
...
@Documented
@Inherited
@Schema(description = "TabsTransfer 文档：https://baidu.gitee.io/amis/docs/components/form/tabs-transfer")
...
//////////////////////////////////////////////
     ...
     * @see 
     */
    @Schema(description = "结果（右则）列表的检索功能，当设置为true时，可以通过输入检索模糊匹配检索内容")
