...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"input-range","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "表单项类型")
    String type() default "input-range";

    /**
     * 最大值
     *
     * 参考定义: {"anyOf":[{"type":"number"},{"$ref":"#/definitions/SchemaTokenizeableString"}],"description":"最大值"}
     *
     ...
     * 最小值
     *
     * 参考定义: {"anyOf":[{"type":"number"},{"$ref":"#/definitions/SchemaTokenizeableString"}],"description":"最小值"}
     *
     * [{"type":"number"},{"$ref":"#/definitions/SchemaTokenizeableString"}]
     *
     * 
     ...
     * 步长
     *
     * 参考定义: {"anyOf":[{"type":"number"},{"$ref":"#/definitions/SchemaTokenizeableString"}],"description":"步长"}
     *
     * [{"type":"number"},{"$ref":"#/definitions/SchemaTokenizeableString"}]
     *
     * 
     ...
     * 单位
     *
     * 参考定义: {"type":"string","description":"单位"}
     *
     * 
     *
     * 
     ...
     * 是否展示步长
     *
     * 参考定义: {"type":"boolean","description":"是否展示步长"}
     *
     * 
     *
     * 
     ...
     * 分割块数
     *
     * 参考定义: {"anyOf":[{"type":"number"},{"type":"array","items":{"type":"number"}}],"description":"分割块数"}
     *
     ...
     * 刻度
     *
     * 参考定义: {"type":"object","additionalProperties":{"anyOf":[{"type":"string"},{"type":"number"},{"$ref":"#/definitions/SchemaObject"},{"type":"object","properties":{"style":{"$ref":"#/definitions/React.CSSProperties"},"label":{"type":"string"}},"additionalProperties":false}]},"description":"刻度"}
     *
     * 
     *
     * 
     ...
     * 是否展示标签
     *
     * 参考定义: {"type":"boolean","description":"是否展示标签"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否展示标签")
    boolean tooltipVisible() default false;

    /**
     * 标签方向
     *
     * 参考定义: "#/definitions/TooltipPosType"
     *
     * 
     *
     * 
     ...
     * 是否为双滑块
     *
     * 参考定义: {"type":"boolean","description":"是否为双滑块"}
     *
     * 
     *
     * 
     ...
     * 是否通过分隔符连接
     *
     * 参考定义: {"type":"boolean","description":"是否通过分隔符连接"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否通过分隔符连接")
    boolean joinValues() default false;

    /**
     * 分隔符
     *
     * 参考定义: {"type":"string","description":"分隔符"}
     *
     * 
     *
     * 
     ...
     * 是否展示输入框
     *
     * 参考定义: {"type":"boolean","description":"是否展示输入框"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否展示输入框")
    boolean showInput() default false;

    /**
     * 输入框是否可清除
     *
     * 参考定义: {"type":"boolean","description":"输入框是否可清除"}
     *
     * 
     *
     * 
