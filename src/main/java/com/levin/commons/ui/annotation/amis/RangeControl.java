...
@Documented
@Inherited
@Schema(description = "RangeControl")
...
//////////////////////////////////////////////
     ...
     * @see 
     */
    @Schema(description = "是否展示步长")
    boolean showSteps() default false;

    /**
     * 分割块数
     *
     * 参考定义: {"type":"number","description":"分割块数"}
     *
     * @see 
     */
    @Schema(description = "分割块数")
    double parts() default 0;

    /**
     * 刻度
     *
     * 参考定义: {"type":"object","additionalProperties":{"type":"array","items":{"anyOf":[{"$ref":"#/definitions/SchemaObject"},{"type":"object","properties":{"style":{"$ref":"#/definitions/React.CSSProperties"},"label":{"type":"string"}},"additionalProperties":false}]}},"description":"刻度"}
     *
     * @see 
     */
