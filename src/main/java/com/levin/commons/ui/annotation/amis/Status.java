...
@Documented
@Inherited
@Schema(title = "状态展示控件。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/status")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
    ...
    @Schema(title = "新版配置映射源的字段 可以兼容新版icon并且配置颜色 2.8.0 新增")
