 ...
 * LocationControl
 *
 * Location 选点组件 文档：https://baidu.gitee.io/amis/docs/components/form/location
...
@Documented
@Inherited
@Schema(description = "Location 选点组件 文档：https://baidu.gitee.io/amis/docs/components/form/location")
...
//////////////////////////////////////////////
    ...
    @Schema(description = "有的地图需要设置 ak 信息")
    String ak() default "	";
