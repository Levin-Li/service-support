...
@Documented
@Inherited
@Schema(title = "Location 选点组件 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/location")
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"location-picker","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "表单项类型")
    String type() default "location-picker";

    /**
     * 选择地图类型
     *
     * 参考定义: {"type":"string","enum":["baidu","gaode","tenxun"],"description":"选择地图类型"}
     *
     * 
     *
     * 
     ...
     * 有的地图需要设置 ak 信息
     *
     * 参考定义: {"type":"string","description":"有的地图需要设置 ak 信息"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "有的地图需要设置 ak 信息")
    String ak() default "	";

    /**
     * 是否自动选中当前地理位置
     *
     * 参考定义: {"type":"boolean","description":"是否自动选中当前地理位置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否自动选中当前地理位置")
    boolean autoSelectCurrentLoc() default false;

    /**
     * 是否限制只能选中当前地理位置 备注：可用于充当定位组件，只允许选择当前位置
     *
     * 参考定义: {"type":"boolean","description":"是否限制只能选中当前地理位置 备注：可用于充当定位组件，只允许选择当前位置"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否限制只能选中当前地理位置 备注：可用于充当定位组件，只允许选择当前位置")
    boolean onlySelectCurrentLoc() default false;

    /**
     * 开启只读模式后的占位提示，默认为“点击获取位置信息” 备注：区分下现有的placeholder（“请选择位置”）
     *
     * 参考定义: {"type":"string","description":"开启只读模式后的占位提示，默认为“点击获取位置信息” 备注：区分下现有的placeholder（“请选择位置”）"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "开启只读模式后的占位提示，默认为“点击获取位置信息” 备注：区分下现有的placeholder（“请选择位置”）")
    String getLocationPlaceholder() default "	";
