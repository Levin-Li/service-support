...
@Documented
@Inherited
@Schema(title = "复选框 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/checkboxes")
public @interface CheckboxesControl {
///////////////////////////////////////////
...
//////////////////////////////////////////////
     ...
     * 表单项类型
     *
     * 参考定义: {"type":"string","const":"checkboxes","description":"表单项类型"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "表单项类型")
    String type() default "checkboxes";

    /**
     * 是否开启全选功能
     *
     * 参考定义: {"type":"boolean","description":"是否开启全选功能"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否开启全选功能")
    boolean checkAll() default false;

    /**
     * 是否默认全选
     *
     * 参考定义: {"type":"boolean","description":"是否默认全选"}
     *
     * 
     *
     * 
     ...
     * 全选/不选文案
     *
     * 参考定义: {"type":"string","description":"全选/不选文案"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "全选/不选文案")
    String checkAllText() default "	";

    /**
     * 每行显示多少个
     *
     * 参考定义: {"anyOf":[{"type":"number"},{"type":"array","items":{"type":"number"}}],"description":"每行显示多少个"}
     *
    ...
    @Schema(title = "每行显示多少个")
    String columnsCount() default "	";

    /**
     * 自定义选项展示
     *
     * 参考定义: {"type":"string","description":"自定义选项展示"}
     *
     * 
     *
     * 
