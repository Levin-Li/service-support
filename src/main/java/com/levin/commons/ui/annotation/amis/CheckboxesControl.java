 ...
 * CheckboxesControl
 *
 * 复选框 文档：https://baidu.gitee.io/amis/docs/components/form/checkboxes
...
@Documented
@Inherited
@Schema(description = "复选框 文档：https://baidu.gitee.io/amis/docs/components/form/checkboxes")
