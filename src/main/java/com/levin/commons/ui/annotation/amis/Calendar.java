...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     *
     * [{"type":"array","items":{"type":"object","properties":{"startTime":{"type":"string"},"endTime":{"type":"string"},"content":{},"className":{"type":"string"}},"required":["startTime","endTime","content"],"additionalProperties":false}},{"type":"string"}]
     *
     * 
     *
     * @see 
     ...
     * 是否开启放大模式
     *
     * 参考定义: {"type":"boolean","description":"是否开启放大模式"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "是否开启放大模式")
    boolean largeMode() default false;

    /**
     * 今日激活时的自定义样式
     *
     * 参考定义: {"type":"object","description":"今日激活时的自定义样式"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "今日激活时的自定义样式")
    String todayActiveStyle() default "	";
