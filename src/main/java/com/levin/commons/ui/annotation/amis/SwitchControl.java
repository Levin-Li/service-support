 ...
 * SwitchControl
 *
 * Switch 文档：https://baidu.gitee.io/amis/docs/components/form/switch
...
@Documented
@Inherited
@Schema(description = "Switch 文档：https://baidu.gitee.io/amis/docs/components/form/switch")
...
//////////////////////////////////////////////
     ...
     * 开启时显示的内容
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"$ref":"#/definitions/IconSchema"}],"description":"开启时显示的内容"}
     *
     * [{"type":"string"},{"$ref":"#/definitions/IconSchema"}]
     *
     * 
     *
     * @see 
    ...
    @Schema(description = "开启时显示的内容")
    String onText() default "	";

    /**
     * 关闭时显示的内容
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"$ref":"#/definitions/IconSchema"}],"description":"关闭时显示的内容"}
     *
     * [{"type":"string"},{"$ref":"#/definitions/IconSchema"}]
     *
     * 
