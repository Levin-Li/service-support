...
@Documented
@Inherited
@Schema(title = "Switch 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/switch")
...
//////////////////////////////////////////////
     ...
     * 开关尺寸
     *
     * 参考定义: {"type":"string","enum":["sm","md"],"description":"开关尺寸"}
     *
     * 
     *
     * 
     ...
     * 指定为多行文本输入框
     *
     * 参考定义: {"type":"string","const":"switch","description":"指定为多行文本输入框"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "指定为多行文本输入框")
    String type() default "switch";

    /**
     * 勾选值
     *
     * 参考定义: {"type":["boolean","string","number"],"description":"勾选值"}
     *
     * 
     *
     * 
     ...
     * 未勾选值
     *
     * 参考定义: {"type":["boolean","string","number"],"description":"未勾选值"}
     *
     * 
     *
     * 
     ...
     * 选项说明
     *
     * 参考定义: {"type":"string","description":"选项说明"}
     *
     * 
     *
     * 
     ...
     * 开启时显示的内容
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"$ref":"#/definitions/IconSchema"},{"$ref":"#/definitions/SchemaCollection"}],"description":"开启时显示的内容"}
     *
     * [{"type":"string"},{"$ref":"#/definitions/IconSchema"},{"$ref":"#/definitions/SchemaCollection"}]
     *
     * 
     *
     * @see 
    ...
    @Schema(title = "开启时显示的内容")
    String onText() default "	";

    /**
     * 关闭时显示的内容
     *
     * 参考定义: {"anyOf":[{"type":"string"},{"$ref":"#/definitions/IconSchema"},{"$ref":"#/definitions/SchemaCollection"}],"description":"关闭时显示的内容"}
     *
     * [{"type":"string"},{"$ref":"#/definitions/IconSchema"},{"$ref":"#/definitions/SchemaCollection"}]
     *
     * 
