...
////////////////////////////////////////////
     ...
     * 开启时显示的文本
     *
     * 参考定义: {"type":"string","description":"开启时显示的文本"}
     *
     * @see 
     */
    @Schema(description = "开启时显示的文本")
    String onText() default "";

    /**
     * 关闭时显示的文本
     *
     * 参考定义: {"type":"string","description":"关闭时显示的文本"}
     *
     * @see 
     */
    @Schema(description = "关闭时显示的文本")
