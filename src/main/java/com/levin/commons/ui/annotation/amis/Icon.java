...
@Documented
@Inherited
@Schema(title = "Icon 图标渲染器 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/icon")
...
//////////////////////////////////////////////
   ...
   String value() default "	";
     ...
     * 按钮类型
     *
     * 参考定义: {"anyOf":[{"$ref":"#/definitions/SchemaTpl"},{"$ref":"#/definitions/IconCheckedSchema"}],"description":"按钮类型"}
     *
     * [{"$ref":"#/definitions/SchemaTpl"},{"$ref":"#/definitions/IconCheckedSchema"}]
     *
     * 
     *
     * @see 
