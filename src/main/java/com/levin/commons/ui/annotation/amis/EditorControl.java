...
@Documented
@Inherited
@Schema(title = "Editor 代码编辑器 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/form/editor")
...
//////////////////////////////////////////////
    ...
    @Schema(title = "是否展示全屏模式开关")
    boolean allowFullscreen() default false;

    /**
     * 获取编辑器底层实例
     *
     * 参考定义: {"type":"string","description":"获取编辑器底层实例"}
     *
     * 
     *
     * 
    ...
    @Schema(title = "获取编辑器底层实例")
    String editorDidMount() default "	";
